...
public class FichaTarot : FichaNoJugador
{
    ...
    public IEnumerator Movement(int numCasillas)
    {
        ...
        TableManager.Instance.GetCasillaArray()[posInicial].ModificarContieneTarot(false);
        while (numCasillas > 0)
        {
            posTablero++;
        ...
        TableManager.Instance.GetCasillaArray()[posTablero].ModificarContieneTarot(true);
